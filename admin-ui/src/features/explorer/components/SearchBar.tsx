...
function addToHistory(item: Omit<SearchHistoryItem, 'timestamp'>) {
...
export function SearchBar({ onSearch, defaultTenant = 'oliveyoung' }: SearchBarProps) {
  ...
  const suggestions = useMemo<SearchSuggestion[]>(() =>
    ...
    [query, autocompleteData?.suggestions, history]
  )
  ...
  const executeSearch = useCallback(() => {
    ...
    addToHistory({ query, tenant, entityId: parsed.entity })
    onSearch(tenant, parsed.entity, version)
    setIsFocused(false)
  }, [query, defaultTenant, onSearch])
