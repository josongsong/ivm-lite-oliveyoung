...
### 인프라 & 배포
- [Lambda & SQS 환경 설정](./lambda-sqs-setup-guide.md) - Lambda/SQS 세팅, 환경변수, IAM, Terraform

### 외부 API 연동
- [USE Inventory API 연동](./use-inventory-api-integration.md) - USE 상품 재고 조회 API

### SDK Embed
- [SDK Embed 시 CredentialsProvider 주입](./sdk-embed-credentials.md) - 외부 앱 embed 시 AWS 자격 증명 주입

## 관련 문서

- [ADR 목록](../adr/README.md) - 아키텍처 결정사항
- [RFC 아카이브](../rfc_archive/) - 원본 RFC 문서
- [RFC-018 Slice 실행 순서](../rfc/RFC-018-slice-execution-order-enforcement.md) - 의존성 런타임 강제
