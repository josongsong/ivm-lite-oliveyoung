...
-- - alerts (V026)
-- - backfill_jobs (V027)
-- - webhooks (V011, V028에서 DROP)
-- - views (V022, V029에서 DROP)
-- - changesets (V025, V030에서 DROP)
-- - debezium_heartbeat (V006, V031에서 DROP)
-- RawData/Slice/InvertedIndex: DynamoDB 사용 (PostgreSQL 미사용)
