...
open class ViewRef<T : Any>(
    ...
    /**
     * 이 View에 대한 쿼리 시작 (SOTA - IvmClient 기반)
     *
     * @example
     * ```kotlin
     ...
     * ```
     */
    fun query(): com.oliveyoung.ivmlite.sdk.client.QueryBuilder {
        return Ivm.client().query(viewId)
    }
    ...
    fun typedQuery(): TypedQueryBuilder<T> {
        return TypedQueryBuilder(Ivm.getConfig(), this)
    }
