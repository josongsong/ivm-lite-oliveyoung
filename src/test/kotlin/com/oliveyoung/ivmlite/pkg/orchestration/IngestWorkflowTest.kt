...
class IngestWorkflowTest : StringSpec({
    ...
    "성공: 새 데이터 저장" {
        ...
        result.shouldBeInstanceOf<IngestWorkflow.Result.Ok<Unit>>()
    }
    ...
    "충돌: 같은 key/version, 다른 payload → Err" {
        ...
        result2.shouldBeInstanceOf<IngestWorkflow.Result.Err>()
    }
    ...
    "실패: 잘못된 JSON → Err" {
        ...
        result.shouldBeInstanceOf<IngestWorkflow.Result.Err>()
    }
    ...
    "Outbox 통합: Ingest 성공 시 Outbox에 이벤트 저장" {
        ...
        pending.shouldBeInstanceOf<OutboxRepositoryPort.Result.Ok<*>>()
        val entries = (pending as OutboxRepositoryPort.Result.Ok).value
